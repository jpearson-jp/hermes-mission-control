/* mission-control — generated by build.sh from src/; edit src/ and re-run, do not edit this file. */
(function () {
  "use strict";

  var SDK = window.__HERMES_PLUGIN_SDK__;
  if (!SDK || !SDK.React) { console.error("mission-control: plugin SDK unavailable"); return; }
  var React = SDK.React;
...
/* --- Project flow: the value-stream funnel, on the hub page ---
  ...
  window.__HERMES_PLUGINS__.register("mission-control", OverviewPage);
})();
